...
const PlayerCard = ({ player }) => {
    ...
    return (
        <Link href={`/dashboard/players/${player.id}`} underline="none">
            <div className="player-card bg-white shadow-md rounded-lg p-4 m-2 flex flex-col items-center transition-transform transform hover:scale-105">
                ...
                <h3 className="text-lg font-bold mt-4">{player.full_name}</h3>
